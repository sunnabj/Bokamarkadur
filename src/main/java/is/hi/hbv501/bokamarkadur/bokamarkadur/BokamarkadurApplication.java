...
public class BokamarkadurApplication {
	...
	class DemoCommandLineRunner implements CommandLineRunner {
		...
		public void run(String... args) throws Exception {
			...
			//REI502M.setSubjects(Subjects.Computer Science);
			REI502M.setSubject("Computer Science");
			...
			//REI502M_2.setSubjects(Subjects.Computer Science);
			REI502M_2.setSubject("Computer Science");
			...
			//TÖL101G.setSubjects(Subjects.Computer Science);
			TÖL101G.setSubject("Computer Science");
			...
			//TÖL104G.setSubjects(Subjects.Computer Science);
			TÖL104G.setSubject("Computer Science");
			...
			//TOL105G.setSubjects(Subjects.Computer Science);
			TOL105G.setSubject("Computer Science");
			...
			//TOL303G.setSubjects(Subjects.Computer Science);
			TOL303G.setSubject("Computer Science");
			...
			//TOL304G.setSubjects(Subjects.Computer Science);
			TOL304G.setSubject("Computer Science");
			...
			//TOL305G.setSubjects(Subjects.Computer Science);
			TOL305G.setSubject("Computer Science");
			...
			//TOL101G.setSubjects(Subjects.Computer Science);
			TOL101G.setSubject("Computer Science");
			...
			//BYG201G.setSubjects(Subjects.Civil Engineering);
			BYG201G.setSubject("Civil Engineering");
			...
			//BYG501G.setSubjects(Subjects.Civil Engineering);
			BYG501G.setSubject("Civil Engineering");
			...
			//BYG503G.setSubjects(Subjects.Civil Engineering);
			BYG503G.setSubject("Civil Engineering");
			...
			//IDN101M.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN101M.setSubject("Industrial and Mechanical Engineering");
			...
			//IDN103G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN103G.setSubject("Industrial and Mechanical Engineering");
			...
			//IDN113F.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN113F.setSubject("Industrial and Mechanical Engineering");
			...
			//IDN122F.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN122F.setSubject("Industrial and Mechanical Engineering");
			...
			//IDN210F.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN210F.setSubject("Industrial and Mechanical Engineering");
			...
			//IDN301G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			IDN301G.setSubject("Industrial and Mechanical Engineering");
			...
			//RAF201G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			RAF201G.setSubject("Industrial and Mechanical Engineering");
			...
			//RAF403G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			RAF403G.setSubject("Industrial and Mechanical Engineering");
			...
			//RAF501G.setSubjects(Subjects.Electrical Computer Engineering);
			RAF501G.setSubject("Electrical Computer Engineering");
			...
			//RAF504G.setSubjects(Subjects.Electrical Computer Engineering);
			RAF504G.setSubject("Electrical Computer Engineering");
			...
			//RAF507M.setSubjects(Subjects.Electrical Computer Engineering);
			RAF507M.setSubject("Electrical Computer Engineering");
			...
			//TOV301G.setSubjects(Subjects.Electrical Computer Engineering);
			TOV301G.setSubject("Electrical Computer Engineering");
			...
			//TOV501M.setSubjects(Subjects.Electrical Computer Engineering);
			TOV501M.setSubject("Electrical Computer Engineering");
			...
			//VEL103M.setSubjects(Subjects.Industrial and Mechanical Engineering);
			VEL103M.setSubject("Industrial and Mechanical Engineering");
			...
			//VEL301G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			VEL301G.setSubject("Industrial and Mechanical Engineering");
			...
			//VEL302G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			VEL302G.setSubject("Industrial and Mechanical Engineering");
			...
			//VEL501M.setSubjects(Subjects.Industrial and Mechanical Engineering);
			VEL501M.setSubject("Industrial and Mechanical Engineering");
			...
			//VEL502G.setSubjects(Subjects.Industrial and Mechanical Engineering);
			VEL502G.setSubject("Industrial and Mechanical Engineering");
