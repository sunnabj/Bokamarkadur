...
public class BokamarkadurApplication {
	...
	class DemoCommandLineRunner implements CommandLineRunner {
		...
		public void run(String... args) throws Exception {
			...
			REI502M.setSubject("COMPUTERSCIENCE");
			...
			REI502M_2.setSubject("COMPUTERSCIENCE");
			...
			TÖL101G.setSubject("COMPUTERSCIENCE");
			...
			TÖL104G.setSubject("COMPUTERSCIENCE");
			...
			TOL105G.setSubject("COMPUTERSCIENCE");
			...
			TOL303G.setSubject("COMPUTERSCIENCE");
			...
			TOL304G.setSubject("COMPUTERSCIENCE");
			...
			TOL305G.setSubject("COMPUTERSCIENCE");
			...
			TOL101G.setSubject("COMPUTERSCIENCE");
			...
			BYG201G.setSubject("CIVILENGINEERING");
			...
			BYG501G.setSubject("CIVILENGINEERING");
			...
			BYG503G.setSubject("CIVILENGINEERING");
			...
			IDN101M.setSubject("Industrial_and_Mechanical_Engineering");
			...
			IDN103G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			IDN113F.setSubject("Industrial_and_Mechanical_Engineering");
			...
			IDN122F.setSubject("Industrial_and_Mechanical_Engineering");
			...
			IDN210F.setSubject("Industrial_and_Mechanical_Engineering");
			...
			IDN301G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			RAF201G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			RAF403G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			RAF501G.setSubject("Electrical_Computer_Engineering");
			...
			RAF504G.setSubject("Electrical_Computer_Engineering");
			...
			RAF507M.setSubject("Electrical_Computer_Engineering");
			...
			TOV301G.setSubject("Electrical_Computer_Engineering");
			...
			TOV501M.setSubject("Electrical_Computer_Engineering");
			...
			VEL103M.setSubject("Industrial_and_Mechanical_Engineering");
			...
			VEL301G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			VEL302G.setSubject("Industrial_and_Mechanical_Engineering");
			...
			VEL501M.setSubject("Industrial_and_Mechanical_Engineering");
			...
			VEL502G.setSubject("Industrial_and_Mechanical_Engineering");
